...
public class gameManager : MonoBehaviour {
	...
	private List<Callback> onGameOverCallbacks = new List<Callback>();
	public void addGameOverListener(Callback cb)
	{
		onGameOverCallbacks.Add(cb);
	}
	...
	public void gameOver() {
		gameIsOver = true;
		foreach (var cb in onGameOverCallbacks)
		{
			cb();
		}
		Time.timeScale = 0;
